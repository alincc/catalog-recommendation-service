...
import no.nb.microservices.clickstream.model.NbUrlNode;
...
public interface IUrlRepository extends GraphRepository<NbUrlNode> {


    NbUrlNode findByValue(String url);

    NbUrlNode findBySesamid(String sesamid);

    List<NbUrlNode> findAllByMediatype(String mediatype);
